...
export function CTA() {
  return (
    <Container as="section" id="contact" className="py-12">
      <div className="relative flex min-h-80 tablet:min-h-120 tablet:flex-row flex-col items-start tablet:items-end justify-end tablet:justify-between gap-8 rounded-panel p-8 tablet:p-12">
